...
@interface BOXSampleFolderViewController () <UIAlertViewDelegate,BOXDownloadDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([item isKindOfClass:[BOXFolder class]]) {
        BOXSampleFolderViewController * controller = [[BOXSampleFolderViewController alloc] initWithClient:self.client folderID:((BOXFolder *)item).modelID];
        controller.delegate = _delegate;
        [self.navigationController pushViewController:controller animated:YES];
    } else {
        BOXSampleFileDetailsController * controller = [[BOXSampleFileDetailsController alloc] initWithClient:self.client itemID:item.modelID itemType:item.type];
...
- (void)importAction:(id)sender
{
    ...
    libraryAssetViewController.delegate = _delegate;
