...
- (id)init
{
    self = [super initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 180)];
...
-(void) createMainUI{
    ...
    CGRect frame2 = CGRectMake(115, 45, 90, 90);
    CGRect frame3 = CGRectMake(115, 45, 90, 90);
  ...
  //  [_talkingImageView release];
    _talkingImageView.alpha = 0.0;
    
    
    labelTimer = [[UILabel alloc]init];
    labelTimer.text = @"00:00";
    [labelTimer setFrame:CGRectMake(0, 140, [UIScreen mainScreen].bounds.size.width, 21)];
    [labelTimer setFont:[UIFont fontWithName:@"HelveticaNeue" size:17]];
    labelTimer.textColor = [UIColor whiteColor];
