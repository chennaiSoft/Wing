//
//  DeleteMyAccountViewController.m
//  ChatApp
//
...
#import "DeleteMyAccountViewController.h"
...
@interface DeleteMyAccountViewController ()

@end

@implementation DeleteMyAccountViewController
...
- (IBAction)action_Continue:(id)sender {
    ...
    [[ChatStorageDB sharedInstance] deleteAllDB:@"Groups"];
    [[ChatStorageDB sharedInstance] deleteAllDB:@"GroupMembers"];
    [[ChatStorageDB sharedInstance] deleteAllDB:@"PasscodeEntry"];
    [[ChatStorageDB sharedInstance] deleteAllDB:@"YoutubeShare"];
    [[ContactDb sharedInstance] deleteAllDB:@"Phone"];
