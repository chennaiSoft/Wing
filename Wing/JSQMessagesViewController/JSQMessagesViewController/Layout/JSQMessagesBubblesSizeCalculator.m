                               ...
                               withLayout:(JSQMessagesCollectionViewFlowLayout *)layout
{
    ...
    if ([messageData isMediaMessage]) {
        ...
        if ([messageData.media isKindOfClass:[CSContactItem class]]) {
            finalSize = [[CSContactItem alloc] mediaViewDisplaySize1];

        }else if ([messageData.media isKindOfClass:[CSAudioItem class]]) {
            finalSize = [[CSAudioItem alloc] mediaViewDisplaySize1];
