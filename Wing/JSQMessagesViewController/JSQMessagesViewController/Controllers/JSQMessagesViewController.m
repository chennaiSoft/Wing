...
//    
//    /*
//    if([[NSUserDefaults standardUserDefaults] boolForKey:@"loadView"] == NO){
...
//    }
//    
//    [[NSUserDefaults standardUserDefaults] setBool:NO forKey:@"loadView"];
...
- (UIImage *)collectionView:(JSQMessagesCollectionView *)collectionView UpdateSendStatus:(NSIndexPath *)indexPath{
    return nil;
}

- (UIImage *)collectionView:(JSQMessagesCollectionView *)collectionView UpdateDeliverStatus:(NSIndexPath *)indexPath{
    return nil;
}

- (UIImage *)collectionView:(JSQMessagesCollectionView *)collectionView UpdateReadStatus:(NSIndexPath *)indexPath{
    return nil;
}
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (isOutgoingMessage) {
        ...
        cell.cellBottomLabel.textAlignment = NSTextAlignmentLeft;
        cell.cellBottomLabel.textColor = [UIColor jsq_messageBubbleGreenColor];

    }

    //updating deliver status images
    if (isOutgoingMessage) {
        
        JSQMessage * jsMessage = [collectionView.dataSource collectionView:collectionView JSQMessageForItemAtIndexPath:indexPath];
        
        if ([jsMessage.messageDic.deliver isEqualToString:@"0"]) {
            cell.sendImageView.image = [UIImage imageNamed:@"dot_normal"];
            cell.deliveryImageView.image = [UIImage imageNamed:@""];
        }
        else if ([jsMessage.messageDic.deliver isEqualToString:@"1"]){
            cell.sendImageView.image = [UIImage imageNamed:@"dot_normal"];
            cell.deliveryImageView.image = [UIImage imageNamed:@"dot_normal"];
        }else if ([jsMessage.messageDic.deliver isEqualToString:@"2"]){
            cell.sendImageView.image = [UIImage imageNamed:@"2"];
            cell.deliveryImageView.image = [UIImage imageNamed:@"2"];
        }else{
            cell.sendImageView.image = [UIImage imageNamed:@"6"];
            cell.deliveryImageView.image = [UIImage imageNamed:@"6"];
        }
    }
